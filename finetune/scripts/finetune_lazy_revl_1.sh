...
DATA="./data/json_data/lazy_ReVL_all_tasks_100000.json"
OUT="./finetune/output/qwen2-7b-trl-sft-lazy_ReVL_all_tasks_10000"
...
python finetune/ReVL_lazy_finetune.py \
